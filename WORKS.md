...
Nome de entrega: `Minha-Bateria-1.0.14.apk`
...
O Works/GitHub Actions publica somente `Minha-Bateria-1.0.14.apk`. O source ZIP é apenas o pacote de desenvolvimento entregue separadamente no chat.

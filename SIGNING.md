...
Importe esses valores como GitHub Secrets. O workflow recria o keystore temporariamente durante o build e gera o APK da versão atual (nesta entrega, `Minha-Bateria-1.0.4.apk`).
